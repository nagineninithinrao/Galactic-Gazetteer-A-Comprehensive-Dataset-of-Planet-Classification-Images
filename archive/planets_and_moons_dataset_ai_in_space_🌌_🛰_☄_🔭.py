...
test_datagen = ImageDataGenerator(
    ...
    data_format=None,
    dtype=None)
train_generator = train_datagen.flow_from_directory(r"C:\Users\nagin\OneDrive\Desktop\major\gatactic gazetter\archive\Planets_Moons_Data\Planets and Moons",target_size=(256, 256),
                                                    batch_size=128,
                                                    class_mode='categorical',
                                                    interpolation="lanczos",
                                                    subset="training")
test_generator = train_datagen.flow_from_directory(r"C:\Users\nagin\OneDrive\Desktop\major\gatactic gazetter\archive\Planets_Moons_Data\Planets and Moons",target_size=(256, 256),
                                                    batch_size=128,
                                                    class_mode='categorical',
                                                    interpolation="lanczos",
                                                    subset="validation")
